// Ej. 15 (IO Distribuida). Corra el siguiente programa con diferentes n´umeros de procesos y describa
// que hace.
...
// lo que hace este codigo es que cada proceso lee 4 datos, en un rango de 0 a 225.